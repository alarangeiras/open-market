import { AddNewMarket, RemoveMarket, UpdateMarket } from '../../domain/usecases';
import { MarketRepository } from '../ports/market-repository';

export class MarketService implements AddNewMarket.UseCase, UpdateMarket.UseCase, RemoveMarket.UseCase {
